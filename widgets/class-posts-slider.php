...
?>
		<div class="posts-slider-wrapper ">
			<h2 class="posts-title" <?php echo $this->get_render_attribute_string('title'); ?>><?php echo $settings['title']; ?></h2>
			<div class="swiper" data-settings='<? echo wp_json_encode($config) ?>'>
